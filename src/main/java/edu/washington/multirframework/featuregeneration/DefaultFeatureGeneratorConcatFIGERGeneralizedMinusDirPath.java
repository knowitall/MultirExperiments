...
public class DefaultFeatureGeneratorConcatFIGERGeneralizedMinusDirPath implements FeatureGenerator{
	...
	public List<String> generateFeatures(Integer arg1StartOffset,
		...
		DefaultFeatureGeneratorGeneralizedMinusDirPath dfg = new DefaultFeatureGeneratorGeneralizedMinusDirPath();
