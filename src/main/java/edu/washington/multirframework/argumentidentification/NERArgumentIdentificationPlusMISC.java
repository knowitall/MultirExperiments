...
public class NERArgumentIdentificationPlusMISC implements
		ArgumentIdentification {

	//only NER Types considered
	private static String[] relevantNERTypes = {"ORGANIZATION", "PERSON", "LOCATION", "MISC"};
	
	private static NERArgumentIdentificationPlusMISC instance = null;
	
	
	private NERArgumentIdentificationPlusMISC(){}
	public static NERArgumentIdentificationPlusMISC getInstance(){
		if(instance == null) instance = new NERArgumentIdentificationPlusMISC();
		return instance;
		}
